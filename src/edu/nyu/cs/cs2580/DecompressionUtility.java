...
public class DecompressionUtility {
	...
	public static void main(String args[]) {
		...
		/*
		 * l.add('2'); l.add('7'); l.add('8'); l.add('6'); l.add('0');
		 * l.add('2'); l.add('D'); l.add('0'); l.add('2'); l.add('B');
		 * l.add('F'); l.add('3');
		 */
	...
	/**
	 * Decodes the encoded list of numbers by removing byte aligning as well as delta encoding
	 * 
